...
function greetUser(name, timeod) {
    if (timeod === "morning" || timeod === "afternoon" || timeod === "evening") {
        return "Good " + timeod + ", " + name + "!"
    } else {

    }
}

console.log('Exercise 5 Result:', greetUser("Shaina", "afternoon"));
